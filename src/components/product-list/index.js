                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    {!product.added && <button onClick={() => this.props.addToCart(i)} className="x-small outlined" data-testid="btn-item-add">
                                        Add To Cart
                                    </button>}

									{product.added && <button onClick={() => this.props.removeFromCart(i)} className="x-small danger" data-testid="btn-item-remove">
                                        Remove
                                    </button>}
                                </div>
                            </div>
